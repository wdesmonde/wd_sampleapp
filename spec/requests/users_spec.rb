...
describe "Users" do
  ...
  describe "sign in/out" do
    ...
    describe "failure" do
      it "should not sign a user in with fields not filled in" do
        visit signin_path
        fill_in :email, :with => ""
        fill_in :password, :with => ""
        click_button
      ...
      it "should not sign a user in with fields with invalid input" do
        visit signin_path
        fill_in :email, :with => "invalid@example."
